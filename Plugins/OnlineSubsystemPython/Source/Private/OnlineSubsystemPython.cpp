...
bool FOnlineSubsystemPython::Shutdown()
{
	...
	if (SessionInterface != nullptr)
		if (SessionInterface->STUNReceiver != nullptr)
			SessionInterface->STUNReceiver->Stop();
	// I can't suspend the thread due to reasons.
	// This is the fastest implementation atm - far from optimal for sanity
